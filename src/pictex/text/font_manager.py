...
class FontManager:
    ...
    def _create_font_typeface(self, font_path_or_name: str) -> Optional[skia.Typeface]:
    ...
    def _create_system_font_typeface(self, font_family: str) -> Optional[skia.Typeface]:
